  ...
  return (
    ...
    <div className="flex  items-center bg-white shadow-lg ">
      ...
      <div className="relative">
        ...
        {profileMenu?<div className="transition ease-in-out duration-500 delay-300 w-24 absolute top-18 right-5 m-2 bg-pink-400 ">
            <ul className="transition ease-in-out duration-300">
              <li className="text-md font-medium text-white hover:bg-pink-300 cursor-pointer  p-2 transition ">Profile</li>
              <li className="text-md font-medium text-white hover:bg-pink-300 cursor-pointer  p-2 transition ">Settings</li>
              <li className="text-md font-medium text-white hover:bg-pink-300 cursor-pointer  p-2 transition " onClick={handleAuthentication}>Login</li>
            </ul>
        </div>:null}
      </div>
      </div>
