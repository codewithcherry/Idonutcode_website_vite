    ...
    <div className="flex  items-center bg-white shadow-lg ">
      ...
      <div className="w-full mx-2">
        <ul className="flex box-border">
          <li className="mx-4  hover:border-b-2 border-blue-400 active:border-b-2 active:border-blue-300">Home</li>
          <li className="mx-4 hover:border-b-2 border-blue-400 active:border-b-2 active:border-blue-300">Course</li>
          <li className="mx-4 hover:border-b-2 border-blue-400 active:border-b-2 active:border-blue-300">Blogs</li>
          <li className="mx-4 hover:border-b-2 border-blue-400 active:border-b-2 active:border-blue-300">About</li>
        </ul>
      </div>
      <div className="mx-4 relative">
        <input className="block w-full rounded-md  py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-inset focus:ring-2  focus:ring-blue-600 sm:text-sm sm:leading-6" type="text" placeholder="search"/>
        <svg className="absolute left-1 top-2 " width="24px" height="24px" viewBox="-4.56 -4.56 33.12 33.12" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M15.7955 15.8111L21 21M18 10.5C18 14.6421 14.6421 18 10.5 18C6.35786 18 3 14.6421 3 10.5C3 6.35786 6.35786 3 10.5 3C14.6421 3 18 6.35786 18 10.5Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
      </div>
