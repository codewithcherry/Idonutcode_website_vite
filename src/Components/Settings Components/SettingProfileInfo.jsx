    ...
    <div className='bg-white m-0 shadow-md p-2 h-full'>
      ...
      <p className='text-red-500 text-center'>This information is public visibile to everyone</p>
        ...
        <div className='relative'>
           {edit &&  <button className='z-10 flex p-2 m-2 absolute top-4 right-4 font-medium bg-slate-300 rounded-2xl text-slate-600' 
      ...
      <div className='p-2 m-2 my-4 w-full border-2 rounded-md bg-white'>
      <div className='relative'>
        <label htmlFor="" className='absolute top-4 px-1 bg-white left-3 text-md text-slate-600 '>Username</label><br />
      ...
      <div>
        <label htmlFor="" className='text-lg text-slate-600 m-2'>Cover Picture</label>
      ...
      {!edit && <div className='text-right m-2 p-2'>
        <button className='p-2 m-2 bg-green-400 text-white font-bold  shadow-md rounded-lg hover:bg-green-500'>Apply Changes</button>
        <button className='p-2 m-2 bg-red-500 text-white font-bold  shadow-md rounded-lg hover:bg-red-600' 
