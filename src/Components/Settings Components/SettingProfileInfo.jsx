    ...
    <div className='bg-white m-0 shadow-md p-2 h-full'>
      ...
      <p className='text-red-500 text-center'>This information is public visibile to everyone</p>
        ...
        <div className='relative'>
           {edit &&  <button className='z-10 flex p-2 m-2 absolute top-4 right-4 bg-slate-300 rounded-2xl' 
      ...
      <div className='p-2 m-2 w-full border-2 rounded-md bg-white'>
      <div className='relative'>
        <label htmlFor="" className='absolute top-4 px-2 bg-white left-3 text-md text-slate-600 '>Username</label><br />
      ...
      <div className='relative '>
        <label htmlFor="" className='absolute top-4 left-2 px-2  bg-white text-lg text-slate-600 '>email</label> <br />
